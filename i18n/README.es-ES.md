...
- Repositorio: donde sea; `~/.openclaw/workspace/agenteiamail` en OpenClaw,
  `~/.hermes/workspace/agenteiamail` en Hermes Agent o
  `~/.claude/workspace/agenteiamail` en Claude Code si no hay preferencia
